...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-matte pb-12 pt-6 md:pb-16 md:pt-8"
      aria-labelledby="hero-heading"
    >
      <HeroBackdropPattern />

      <div className="relative z-[1] mx-auto max-w-6xl px-3 sm:px-4">
        <div className="rounded-2xl bg-white p-4 shadow-xl sm:rounded-[2rem] sm:p-6 md:p-8 lg:p-10">
          {/* Reference-style top bar: logo · links · search · profile */}
          <div className="mb-6 flex flex-col gap-4 border-b border-neutral-200 pb-5 sm:mb-8 sm:gap-5 sm:pb-6 md:mb-10 md:flex-row md:items-center md:justify-between md:gap-4">
            <Link href="/" className="shrink-0" aria-label="MK GADGETS home">
              <Logo variant="dark" layout="inline" className="scale-95 md:scale-100" />
            </Link>
            ...
            >
              ...
              <span className="relative inline-flex flex-col items-center pt-2">
                <span className="absolute -top-1 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-neutral-200 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-matte">
                  New
                </span>
              ...
              <Link href="/#categories" className="transition hover:text-matte">
                Categories
              </Link>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
            <div className="order-2 text-center lg:order-1 lg:text-left">
              ...
              <div className="mt-8 flex w-full max-w-md flex-col items-stretch gap-4 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:justify-center lg:max-w-none lg:justify-start">
                ...
                <Link
                  href="/cart"
                  className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-full bg-matte px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-charcoal sm:min-h-[52px] sm:px-8"
                >
            ...
            <div className="order-1 lg:order-2">
              <div className="mx-auto flex max-w-[440px] flex-col items-center gap-6 sm:flex-row sm:items-center lg:max-w-none lg:justify-end">
                <div className="relative w-full max-w-[360px]">
                  <div className="relative mx-auto aspect-square w-full max-w-[360px] overflow-hidden rounded-full shadow-lg ring-4 ring-neutral-200">
                    <Image
                      src={mainImage}
                      alt="Premium gadgets and electronics"
                      fill
                      priority
                ...
                <div className="flex flex-row gap-3 sm:flex-col sm:gap-3">
                  {thumbImages.map((src) => (
                    <div
                      key={src}
                      className="relative size-14 overflow-hidden rounded-full border-2 border-white shadow-md ring-2 ring-neutral-200 sm:size-16"
                    >
                      <Image
                        src={src}
                        alt=""
